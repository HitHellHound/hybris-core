 ...
 */
package superconcerttours.service.impl;
...
public class DefaultSuperconcerttoursService implements SuperconcerttoursService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSuperconcerttoursService.class);
	...
	{
		return DefaultSuperconcerttoursService.class.getResourceAsStream("/superconcerttours/sap-hybris-platform.png");
	}
