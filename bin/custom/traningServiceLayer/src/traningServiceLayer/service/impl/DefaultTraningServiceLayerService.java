...
public class DefaultTraningServiceLayerService implements TraningServiceLayerService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTraningServiceLayerService.class);
	...
	{
		return DefaultTraningServiceLayerService.class.getResourceAsStream("/traningServiceLayer/sap-hybris-platform.png");
	}
